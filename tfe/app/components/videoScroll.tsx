  ...
  useEffect(() => {
    ...
    function updateText(frameIndex: number) {
      if (frameIndex < 5 || frameIndex >= 70) {
        ...
        setActiveText({
          text: "In this installation example, a camera monitors three strawberry plants. The camera is positioned 35 cm (about 14 inches) from the gutter. It’s entirely possible that it could monitor more plants if the camera were positioned further back.",
